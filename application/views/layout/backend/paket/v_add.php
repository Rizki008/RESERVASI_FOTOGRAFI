            ...
            <h5><i class="icon fas fa-exclamation-triangle"></i>', '</h5></div>');
                ...
                <h5><i class="icon fas fa-exclamation-triangle"></i>' . $error_upload . '</h5></div>';
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama_paket" value="<?= set_value('nama_paket') ?>" placeholder="Name" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="harga" aria-describedby="name" value="<?= set_value('harga') ?>" placeholder="Harga" required>
                        </div>
                        <div class="form-group">
                            <label>Diskon</label>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="content" name="deskripsi" value="<?= set_value('deskripsi') ?>" rows="4" required></textarea>
                        </div>
                        <div class="form-group">
                            <label>Sayarat Dan Ketentuan</label>
                            <textarea id="contentsatu" name="ketentuan" value="<?= set_value('ketentuan') ?>" rows="4" required></textarea>
                        </div>
