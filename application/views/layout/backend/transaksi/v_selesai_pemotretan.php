                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 p-0">
                            ...
                            <li class="breadcrumb-item text-muted active" aria-current="page">Selesai Pemotretan</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Selesai Pemotretan</h4>
                                    ...
                                    foreach ($pesanan_selesai as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td><b>Rp. <?= number_format($value->jumlah_bayar, 0)  ?></b><br>
                                                <span class="badge badge-success">Telah selesai Pemotretan</span>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
