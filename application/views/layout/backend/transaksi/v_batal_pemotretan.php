                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 p-0">
                            ...
                            <li class="breadcrumb-item text-muted active" aria-current="page">Pembatalan</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <table class="table table-dark mb-0">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Catatan Pembatalan</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php $no = 1;
                            foreach ($pesanan_dibatalkan as $key => $value) { ?>
                                <tr>
                                    <th scope="row"><?= $no++ ?></th>
